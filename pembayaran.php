      ...
      <nav class="navbar bg-light mt-2">
        <div class="container-fluid">
          ...
          <form class="d-flex" role="search">
            ...
            <a href="index2.php" class="btn btn-outline-success" type="submit">TAMBAH CUSTOMER</a>
          </form>
        </div>
      </nav>
      ...
      <table class="table table-bordered border-primary table-success table-striped table-hover table-responsive">
        <thead>
          ...
          <tr>
            ...
            <td><?php echo $data['E_money'];?></td>
            <td><?php echo $data['M_banking'];?></td>
            
            <td>
            <a href="olah.php?id=<?php echo $data['id']; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-vector-pen" viewBox="0 0 16 16">
