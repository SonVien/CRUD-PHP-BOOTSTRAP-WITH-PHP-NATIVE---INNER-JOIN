...
?>
  ...
  <body>
    ...
    <nav class="navbar bg-light mt-2">
      ...
      <form action="proses.php" method="post" <form method="get">
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="nama" name="nama" placeholder="soleh" value="<?php echo $nama; ?>">
    </div>
  </div>
  <div class="mb-3 row">
    <label for="alamat" class="col-sm-2 col-form-label">alamat</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="alamat" name="alamat" placeholder="jl.sukun no 99" value="<?php echo $alamat; ?>">
    </div>
  </div>
  <div class="mb-3 row">
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="nomor_hp" name="nomor_hp" placeholder="+62-0998-9876-9887" value="<?php echo $nomor_hp; ?>">
    </div>
  </div>
</div>
    <div class="mb-3 row">
